def calculate_mental_health_score(pmi, omi):
    # Calculate the mental health score
    mental_health_score = pmi * omi
...
omi = ask_outcome("Enter the outcome of mental health (1 to 100): ")
pj = ask_question("Enter the probability of job stability (0 to 100): ")
oj = ask_outcome("Enter the outcome of job stability (1 to 100): ")

# Calculate the mental health score separately
mental_health_score = calculate_mental_health_score(pmi, omi)
...
# Calculate the overall life outcome
life_outcome = calculate_life_outcome(pc, oc, pr, or_, ph, oh, pf, of, pm, om, pe, oe, pl, ol, pp, op, pmi, omi, pj, oj)
life_interpretation = interpret_life_outcome(life_outcome)
print(f'Calculated Life Outcome: {life_outcome:.2f}')
print(f'Interpretation: {life_interpretation}')
