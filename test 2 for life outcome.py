...
def calculate_life_outcome(pc, oc, pr, or_, ph, oh, pf, of, pm, om, pe, oe, pl, ol, pp, op, pmi, omi, pj, oj):
    # Base probabilities (scaled to 125)
    base_probs = {
        'pc': 90, 'pr': 75, 'ph': 100, 'pf': 80, 'pm': 60,
        'pe': 95, 'pl': 75, 'pp': 85, 'pmi': 110, 'pj': 70
    }
    weights = {
    ...
    return life_outcome  # No need to scale down
    ...
    while True:
        try:
            ...
            if 0 <= value <= 125:
                ...
                print("Please enter a value between 0 and 125.")
        except ValueError:
            print("Invalid input. Please enter a numerical value between 0 and 125.")
    ...
    while True:
        try:
            ...
            if 1 <= value <= 125:
                ...
                print("Please enter a value between 1 and 125.")
        except ValueError:
            print("Invalid input. Please enter a numerical value between 1 and 125.")

# Collect values using the new functions
pc = ask_question("Enter the probability of career success (0 to 125): ")
oc = ask_outcome("Enter the outcome of career success (1 to 125): ")
pr = ask_question("Enter the probability of relationship success (0 to 125): ")
or_ = ask_outcome("Enter the outcome of relationship success (1 to 125): ")
ph = ask_question("Enter the probability of health stability (0 to 125): ")
oh = ask_outcome("Enter the outcome of health stability (1 to 125): ")
pf = ask_question("Enter the probability of financial stability (0 to 125): ")
of = ask_outcome("Enter the outcome of financial stability (1 to 125): ")
pm = ask_question("Enter the probability of successful move (0 to 125): ")
om = ask_outcome("Enter the outcome of successful move (1 to 125): ")
pe = ask_question("Enter the probability of educational attainment (0 to 125): ")
oe = ask_outcome("Enter the outcome of educational attainment (1 to 125): ")
pl = ask_question("Enter the probability of leisure satisfaction (0 to 125): ")
